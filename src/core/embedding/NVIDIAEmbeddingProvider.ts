...
import type { LearnedEmbeddingProvider } from '../TensorLogicEngineEnhancements';

export type NvidiaEmbedInputType = 'query' | 'passage';

export const DEFAULT_NVIDIA_EMBED_URL = 'https://integrate.api.nvidia.com/v1/embeddings';
...
export class NVIDIAEmbeddingProvider implements LearnedEmbeddingProvider {
  ...
  private async embed(texts: string[], inputType: NvidiaEmbedInputType): Promise<number[][]> {
