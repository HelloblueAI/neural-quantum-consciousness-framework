...
export class ReasoningEngine {
  ...
  public async reasonForTests(input: any, context?: Record<string, any>): Promise<any> {
    try {
      ...
      this.logger.error('Error in test reasoning, falling back to simple reasoning', error as Error);
  ...
  private simpleReasoningForTests(input: any, context?: Record<string, any>): any {
  ...
  private generateInsights(result: ReasoningResult): string[] {
